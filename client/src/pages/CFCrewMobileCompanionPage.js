...
// Custom Feature: Crew mobile companion
// Crew mobile companion: Field app with job details, before/after photo capture, real-time routing, weather alerts, safety protocols; AI provides real-time guidance
import React, { useState } from 'react';

export default function CFCrewMobileCompanionPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-crew-mobile-companion/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Crew mobile companion</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Crew mobile companion: Field app with job details, before/after photo capture, real-time routing, weather alerts, safety protocols; AI provides real-time guidance</p>
